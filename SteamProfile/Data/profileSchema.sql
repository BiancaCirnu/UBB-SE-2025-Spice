...
VALUES 
    (1, 'ms-appx:///Assets/ProfilePictures/default.png', 'Gaming enthusiast and software developer', GETDATE()),
    (2, 'ms-appx:///Assets/ProfilePictures/default.png', 'Game developer and tech lover', GETDATE()),
    (3, 'ms-appx:///Assets/ProfilePictures/default.png', 'Casual gamer and streamer', GETDATE());

INSERT INTO UserProfiles (user_id, profile_picture, bio,last_modified)
VALUES 
	(4, 'ms-appx:///Assets/ProfilePictures/default.png', 'Casual gamer and streamer', GETDATE()),
	(5, 'ms-appx:///Assets/ProfilePictures/default.png', 'Casual gamer and streamer', GETDATE());

insert into UserProfiles(user_id, profile_picture, bio) values
(11, 'Assets/download.jpg' ,'hey');
